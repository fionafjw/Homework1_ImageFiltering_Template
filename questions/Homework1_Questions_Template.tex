...
\begin{itemize}
    \item 5 questions \textbf{[12 + 9 + 13 + 14 + 7 = 55]}.
...
% Please leave the pagebreak
\pagebreak
\paragraph{Q2:} \textbf{[9 points]} Now that we've de-noised our image of the Orion nebula, let's explore filtering techniques more closely. Two kinds of linear filtering are correlation and convolution.
...
\pagebreak
    ...
    How will the output image change depending on the order in which we apply the filters? Will the behavior be different for convolution versus correlation? Explain some possible benefits or disadvantages to both approaches. \textbf{[5--6 sentences]}
    \end{tcolorbox}
