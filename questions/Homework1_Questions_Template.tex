...
\begin{itemize}
    \item 5 questions \textbf{[12 + 7 + 13 + 14 + 7 = 53]}.
...
% Please leave the pagebreak
\pagebreak
\paragraph{Q2:} \textbf{[7 points]} Now that we've de-noised our image of the Orion nebula, let's explore filtering techniques more closely. Two kinds of linear filtering are correlation and convolution.
